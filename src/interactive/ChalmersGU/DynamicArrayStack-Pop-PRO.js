...
(function() {
  ...
  var DynamicArrayStackPopPRO = {
    userInput: null,      // Boolean: Tells us if user ever did anything

    // Initialise the exercise
    initJSAV: function(max_size, arr_size) {
      var i;
      DynamicArrayStackPopPRO.userInput = false;
      selectedIndex = -1;
  ...
  function reset(max_size, arr_size) {
    ...
    if ($("#DynamicArrayStack-Pop-PRO")) { $("#DynamicArrayStack-Pop-PRO").empty(); }

    // Set up the display
    av = new JSAV("DynamicArrayStack-Pop-PRO");
  ...
  function clickHandler(index) {
    ...
    DynamicArrayStackPopPRO.userInput = true;
  }
  ...
  window.DynamicArrayStackPopPRO = window.DynamicArrayStackPopPRO || DynamicArrayStackPopPRO;
}());
