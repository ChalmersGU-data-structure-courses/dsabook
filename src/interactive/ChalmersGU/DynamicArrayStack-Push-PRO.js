...
(function() {
  ...
  function reset(max_size, curr_size) {
    ...
    if ($("#DynamicArrayStack-Push-PRO")) { $("#DynamicArrayStack-Push-PRO").empty(); }

    // Set up the display
    av = new JSAV("DynamicArrayStack-Push-PRO");
    ...
    DynamicArrayStackPushPRO.userInput = false;
  }
  ...
  function clickHandler(index) {
    ...
    DynamicArrayStackPushPRO.userInput = true;
  }
  ...
  window.DynamicArrayStackPushPRO = window.DynamicArrayStackPushPRO || DynamicArrayStackPushPRO;
}());
