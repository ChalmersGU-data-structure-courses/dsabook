...
$(document).ready(function() {
  ...
  var interpret = {
	  ...
	  "Slide 3": "The pivot partitions the array into two parts one of size <em>0</em> and the other of size <em>n–1</em> ... This requires <em>n–1</em> units of work",
	  "Slide 4": "For the <em>n–1</em> partition, the pivot breaks it into two parts one of size <em>0</em> and the other of size <em>n–2</em> ... This requires <em>n–2</em> units of work",
	  "Slide 5": "For the <em>n–2</em> partition, the pivot breaks it into two parts one of size <em>0</em> and the other of size <em>n–3</em> ... This requires <em>n–3</em> amount of work",
	  "Slide 6": "In the last level, the pivot breaks a partition of size <em>2</em> into two parts one of size <em>0</em> and the other of size <em>1</em> ... This requires a single unit of work",
