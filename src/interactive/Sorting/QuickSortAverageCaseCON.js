...
$(document).ready(function() {
  ...
  var interpret = {
	  ...
	  "Slide 9": "And since we have <em>n</em> positions, therefore the average cost of the recursive calls can be modeled as: ",
	  "Slide 10": "But also we need to add the cost for the partition and findpivot functions which is <em>cn</em> for some constant <em>c</em>",
	  "Slide 11": "Accordingly, quicksort's average running time can be modeled by the following recurrence:",
	  "Slide 12": "By solving this recurrence, we will have that quicksort's average running time is <em>O(n log(n))</em>"
  };
