...
$(document).ready(function() {
  ...
  var interpret = {
    "av_c1": "Here is the process for removing the maximum value from a <em>max</em>-heap. We know that this value is at the root (array position 0), but we also need to update the heap when we remove it.",
