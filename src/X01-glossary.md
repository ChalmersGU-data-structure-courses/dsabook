...
:   <!-- TERM: local variable :label: stores -->
...
:   <!-- TERM: directed acyclic graph :label: types -->
...
:   <!-- TERM: composite type :label: synonym -->
...
:   <!-- TERM: growth rate :label: key concept -->
...
:   <!-- TERM: Floyd's algorithm :label: solved by -->
...
:   <!-- TERM: algorithm analysis :label: is -->
...
:   <!-- TERM: amortized complexity :label: used in -->
    <!-- TERM: amortized analysis :label: used in -->
...
:   <!-- TERM: array-based list :label: analogous to -->
...
:   <!-- TERM: intermediate code :label: form of -->
...
:   <!-- TERM: algorithm analysis :label: synonym -->
    <!-- TERM: asymptotic algorithm analysis :label: formal synonym -->
...
:   <!-- TERM: double rotation :label: operations -->
...
:   <!-- TERM: binary search tree :label: example -->
...
:   <!-- TERM: member function :label: can include -->
...
:   <!-- TERM: open addressing :label: synonym -->
...
:   <!-- TERM: assembly code :label: changes -->
...
:   <!-- TERM: collision resolution :label: performs -->
...
:   <!-- TERM: lexical analysis :label: phase -->
...
:   <!-- TERM: Overloading :label: known as -->
...
:   <!-- TERM: serialization :label: concept -->
    <!-- TERM: abstract data type :label: implements -->
    The implementation for an [ADT]{.term}.

data type

:   <!-- TERM: abstract data type :label: implemented by -->
...
:   <!-- TERM: Composite design pattern :label: example -->
...
:   <!-- TERM: peripheral storage :label: example of -->
...
:   <!-- TERM: Floyd's algorithm :label: example -->
...
:   <!-- TERM: state machine :label: synonym  -->
...
:   <!-- TERM: edges \<edge\> :label: contains -->
...
:   <!-- TERM: order of growth :label: synonym -->
...
:   <!-- TERM: complete binary tree :label: is -->
...
:   <!-- TERM: replacement selection :label: variant -->
...
:   <!-- TERM: Parse tree :label: walks through -->
...
:   <!-- TERM: object-space decomposition :label: type -->
...
:   <!-- TERM: array-based list :label: implements -->
...
:   <!-- TERM: automatic variable :label: synonym -->
...
:   <!-- TERM: 80/20 rule :label: example use -->
...
:   <!-- TERM: adversary argument :label: example -->
...
:   <!-- TERM: primary storage :label: storage type -->
    <!-- TERM: secondary storage :label: storage type -->
...
:   <!-- TERM: buddy method :label: example -->
...
:    Abbreviation for [minimal-cost spanning tree]{.term}.
...
:   <!-- TERM: Kruskal's algorithm :label: algorithms -->
    <!-- TERM: Prim's algorithm :label: algorithms -->
    <!-- TERM: MCST :label: abbreviation -->
    <!-- TERM: MST :label: abbreviation -->
    <!-- TERM: cycle :label: never have -->
    <!-- TERM: tree :label: is a -->
...
:   Abbreviation for the [modulus]{.term}
    function.
...
:   <!-- TERM: multi-dimensional search key :label: uses -->
...
:   <!-- TERM: adjacent :label: is -->
    <!-- TERM: graph :label: context -->
    In a [graph]{.term}, a
...
:   <!-- TERM: neighbor :label: linked to -->
    <!-- TERM: dynamic allocation :label: created by -->
    <!-- TERM: depth :label: property -->
...
:   An abbreviation for
    [non-deterministic polynomial](#non-deterministic-polynomial-time-algorithm){.term}.

NP-Complete

:   <!-- TERM: NP :label: is -->
    <!-- TERM: NP-hard :label: is -->
    <!-- TERM: clique :label: example problem -->
    A class of problems that are related to each other in this way:   If
    ever one such problem is proved to be solvable in polynomial time,
...
:   <!-- TERM: NP :label: abbreviation -->
    <!-- TERM: non-deterministic choice :label: operation -->
...
:   <!-- TERM: cohesion :label: key concept -->
    <!-- TERM: inherit :label: principle -->
    <!-- TERM: encapsulation :label: principle -->
    <!-- TERM: polymorphism :label: principle -->
    <!-- TERM: abstraction :label: principle -->
    <!-- TERM: object :label: consists of -->
...
:   A synonym for a [singly linked list]{.term}.
...
:   <!-- TERM: growth rate :label: synonym -->
    <!-- TERM: lower bound :label: type -->
    <!-- TERM: upper bound :label: type -->
    A synonym for [growth rate]{.title-ref}.
...
:   <!-- TERM: compiler :label: part of -->
    <!-- TERM: parse tree :label: build -->
...
:   <!-- TERM: variable :label: is a -->
    <!-- TERM: address :label: value -->
    <!-- TERM: binary tree :label: used in -->
    <!-- TERM: linked list :label: used in -->
    <!-- TERM: pointee :label: point to -->
    <!-- TERM: shallow copy :label: default copy -->
    <!-- TERM: dereference :label: get pointee value -->
    <!-- TERM: initialization :label: requires -->
...
:   <!-- TERM: run-time polymorphism :label: form -->
    <!-- TERM: compile-time polymorphism :label: form -->
    An
    [object-oriented programming](#object-oriented-programming-paradigm){.term}
...
:   Synonym for [primary key index]{.term}.
...
:   <!-- TERM: RAM :label: example -->
    <!-- TERM: main memory :label: synonym -->
...
:   <!-- TERM: greedy algorithm :label: is a -->
    <!-- TERM: Dijkstra's algorith :label: identical to -->
...
:   <!-- TERM: lower bounds proof :label: example -->
    <!-- TERM: NP-Completeness proof :label: example -->
    <!-- TERM: proof by contradiction :label: type -->
    <!-- TERM: proof by induction :label: type -->
...
:   <!-- TERM: dequeue :label: operations -->
    <!-- TERM: enqueue :label: operations -->
...
:   <!-- TERM: random access memory :label: abbreviation for -->
    Abbreviation for [Random Access Memory]{.term}.

radix

:   Synonym for [base]{.term}. The number of
    digits in a number representation. For example, we typically
    represent numbers in base (or radix) 10. Hexidecimal is base (or
    radix) 16.
...
:   Abbreviated [RAM]{.term}, this is the
...
:   <!-- TERM: recurrence relation :label: expressed as -->
    <!-- TERM: recursive function :label: implemented in -->
...
:   <!-- TERM: base case :label: includes -->
    <!-- TERM: recursive call :label: includes -->
    <!-- TERM: binary search :label: example -->
...
:   <!-- TERM: pointer :label: similar to -->
    <!-- TERM: bad reference :label: if not initialized -->
...
:   <!-- TERM: Overriding :label: Known as -->
    A form of [polymorphism]{.term} known as
...
:   <!-- TERM: activation record :label: composed of -->
...
:   <!-- TERM: compiler :label: part of -->
    <!-- TERM: lexical analysis :label: responsible for -->
...
:   <!-- TERM: Binary Search Tree :label: example -->
    <!-- TERM: 2-3 tree :label: example -->
    <!-- TERM: B-tree :label: example -->
    <!-- TERM: search trie :label: example -->
...
:   <!-- TERM: alphabet trie :label: example -->
    <!-- TERM: binary trie :label: example -->
...
:   Synonym for [secondary key index]{.term}.
...
:   <!-- TERM: move-to-front :label: heuristic -->
    <!-- TERM: transpose :label: heuristic -->
...
:   <!-- TERM: deserialization :label: reversed by -->
    <!-- TERM: sequential tree representation :label: example -->
...
:   <!-- TERM: boolean :label: example of -->
    <!-- TERM: integer :label: example of -->
...
:   <!-- TERM: one-way list :label: synonym -->
    A [linked list]{.term} implementation
...
:   <!-- TERM: bintree :label: example -->
    <!-- TERM: kd tree :label: example -->
    <!-- TERM: PR quadtree :label: example -->
...
:   <!-- TERM: push :label: operations -->
    <!-- TERM: pop :label: operations -->
...
:   Another name for a [local variable]{.term}.
...
:   Synonym for [finite automata]{.term}.
...
:   <!-- TERM: parse tree :label: generates -->
    <!-- TERM: tokens :label: accepts -->
...
:   <!-- TERM: alphebet trie :label: example -->
    <!-- TERM: binary trie :label: example -->
    <!-- TERM: search trie :label: example -->
...
:   <!-- TERM: Huffman codes :label: example -->
    <!-- TERM: fixed-length coding:label:   contrast to -->
...
:   <!-- TERM: sequence :label: synonym -->
    <!-- TERM: dynamic array :label: synonym -->
    In set notation, another term for a [sequence]{.term}.
...
:   <!-- TERM: node :label: synonym -->
    Another name for a [node]{.term} in a
    [graph]{.term}.
