...
Insertion sort (@sec:sorting-1:insertion-sort),
Bubble sort (@sec:sorting-1:bubble-sort),
Selection sort (@sec:sorting-1:selection-sort),
Quicksort (@sec:sorting-2:quicksort), and
Mergesort (@sec:sorting-2:mergesort).
