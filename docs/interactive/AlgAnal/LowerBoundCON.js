...
$(document).ready(function() {
  ...
  var interpret = {
    ...
    "sc2": "The lower bound of an algorithm indicates the least amount of a resource that the algorithm needs for a problem of size <em>n</em>. So what is the lower bound of the sequential search algorithm?",
    ...
    "sc4": "In the best case of the algorithm, only a single element is visited. <em>T(n) = 1</em>.<br>So, <em>&Omega;(1)</em> is a lower bound for the algorithm in the best case, because 1 is less than or equal to the number of elements that we look at.",
    "sc5": "In the worst case of the algorithm, <em>n</em> elements are visited. <em>T(n) = n</em>.<br>So, <em>&Omega;(n)</em> is a lower bound for the cost of the algorithm in the worst case because the worst case must <b>always</b> must look at <em>n</em> records.",
    "sc6": "Likewise, in the average case we visit about <em>n/2</em> elements.<br>So, <em>&Omega;(n)</em> is a lower bound for the cost of the algorithm in the average case because for some constant <em>c</em>, <em>cn</em> is less than or equal to the average case cost of <em>n/2</em>.",
    ...
    "sc10": "But, we do have a shorthand that we use to say that we know the upper and lower bounds match. That is to say that the cost is <em>&Theta;</em> some value. Sequential search has worst case cost <em>&Theta;(n)</em> because its upper and lower bounds are the same. Likewise, sequential search has a best case cost of <em>&Theta;(1)</em>.",
    "lab1": "<em>&Omega;(1)</em> in the <b><u>Best Case.</u></b>",
    "lab2": "<em>&Omega;(n)</em> in the <b><u>Worst Case</u></b>.",
    "lab3": "<em>&Omega;(n)</em> in the <b><u>Average Case</u></b>."
  };
  ...
  var nLabel = av.label("<em>n</em>", {top: topAlign - 30, left: leftAlign + 165});
  ...
  var p1 = av.pointer("<em>K</em>", arr1.index(0));
  ...
  var p2 = av.pointer("<em>K</em>", arr2.index(arraySize - 1));
