...
$(document).ready(function() {
  ...
  var interpret = {
    ...
    "sc4": "The total number of comparisons will be <em>n–1</em>, which is the number of times the outer for loop executes.",
    "sc5": "Therefore, the best case running time of insertion sort is <em>O(n)</em>."
  };
  ...
  av.label("<em>i=1</em>",  {top: "240px", left: 330});
  av.g.rect(leftAlign + rectWidth, topAlign, 50, 20);
  av.label("<em>i=2</em>",  {top: "240px", left: "380px"});
  av.g.rect(leftAlign + 2 * rectWidth, topAlign, 50, 20);
  av.label("<em>i=3</em>",  {top: "240px", left: "430px"});
  av.g.rect(leftAlign + 3 * rectWidth, topAlign, 50, 20);
  av.label("<em>i=4</em>",  {top: "240px", left: "480px"});
  av.g.rect(leftAlign + 4 * rectWidth, topAlign, 50, 20);
  av.label("<em>i=5</em>",  {top: "240px", left: "530px"});
