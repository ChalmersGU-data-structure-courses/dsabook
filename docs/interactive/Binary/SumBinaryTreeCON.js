...
$(document).ready(function() {
  ...
  var label1 = av.label(interpret["av_l1"], {left: 295, top: 0}); // create a label for the icon
  av.displayInit();
  ...
  var label2 = av.label(interpret["av_l2"], {left: 90, top: 150}); // create a label for the icon
  ...
  var label3 = av.label(interpret["av_l3"], {left: 500, top: 150}); // create a label for the icon
  var line2 = av.g.line(550, 180, 490, 200,
                        {"stroke-width": "2", "arrow-end": "classic"});
  ...
  line1.hide();
  line2.hide();
  av.label(interpret["av_l4"], {left: 90, top: 150}); // Label for the icon
  av.g.line(230, 170, 370, 100, {"stroke-width": "2", "arrow-end": "classic"});
  av.umsg(interpret["av_c5"]);
  av.step();

  // Slide 6
  av.label(interpret["av_l5"], {left: 500, top: 150}); // Label for the icon
  av.g.line(555, 170, 415, 100, {"stroke-width": "2", "arrow-end": "classic"});
  ...
  av.label(interpret["av_l6"], {left: 290, top: 0}); // Label for the icon
  av.step();
